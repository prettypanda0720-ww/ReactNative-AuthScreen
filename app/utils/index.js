...
export const getCommonPadding = () => {
  const commonPadding = 10;

  return commonPadding;
};

export const getSectioHeight = () => {
  let commonHeight = 200;

  return scaleWithPixel(commonHeight);
};

export const getSectionImgHeight1 = () => {
  let commonHeight = 140;

  return scaleWithPixel(commonHeight);
};

export const getContentHeight1 = () => {
  let commonHeight = 57;

  return scaleWithPixel(commonHeight);
};

export const getSectionImgHeight2 = () => {
  let commonHeight = 110;

  return scaleWithPixel(commonHeight);
};

export const getContentHeight2 = () => {
  let commonHeight = 87;
